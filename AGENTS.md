...
- **UI:** Tamagui primitives and theme tokens. Reuse existing components before making new ones. Colours come from `constants/palette.ts` and the theme until the token file lands (see the design system doc).
