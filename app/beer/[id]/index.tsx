            ...
            >
                ...
                <Animated.View style={[
                    ...
                    <Animated.View style={[styles.stickyTitleContainer, { bottom: 20, left: 20 }, stickyTitleStyle]}>
                        <Text style={[styles.stickyTitleText, { color: '#FFF', textShadowColor: 'rgba(0,0,0,0.5)', textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 4 }]}>{beer?.name}</Text>
                    </Animated.View>
                </Animated.View>
                ...
                >
                    ...
                    <View style={{ flex: 1 }}>
                        ...
                        >
                            <Text style={[styles.title, { fontSize: 32, color: theme.color?.get() as string }]}>{beer.name}</Text>
                        </Swipeable>
                    </View>
                    <TouchableOpacity onPress={() => router.push(`/beer/${id}/edit`)} style={{ padding: 8 }}>
